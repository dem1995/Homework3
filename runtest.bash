...
CREATE	TABLE	experiment_error	AS					SELECT	cores,	loops,	threads,
...
df16	=	df.query('threads	==	16')#	https://pandas.pydata.org/pandas-docs/stable/generated/pandas.DataFrame.plot.html
...
plt.legend(['Threads	2',	'Threads	4',	'Threads	8',	'Threads	16'],
											loc='upper	left')
#	Save	the	two	figuresplt.savefig("{}_rt.png".format(csv_file),	bbox_inches='tight')
